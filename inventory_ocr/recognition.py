...
from inventory_ocr.utils import download_and_unzip, pil_image_to_base64
import platform
import numpy as np
    ...
    def __init__(self, layout_config, app_dir):
        try:
            ...
            raise ImportError(
                ...
                "Please install it using 'pip install inventory-ocr[pero]'"
            ) from e
...
class MistralOCRRecognizer(CardRecognizer):
    ...
    def __init__(self, layout_config):
        ...
        self.mistral_client = Mistral(api_key=api_key,  timeout_ms=300000)
        super().__init__(layout_config)
